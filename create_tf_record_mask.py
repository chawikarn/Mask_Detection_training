...
def main(_):
  label_map_dict = label_map_util.get_label_map_dict('mask_dataset/label_map.pbtxt')

  print('Reading from mask_datasets.')
  image_dir = 'mask_dataset/images'
  annotations_dir = 'mask_dataset/annotations'
  ...
  train_output_path = '/content/drive/MyDrive/dataset_SUT/trainMask.record'
  val_output_path = '/content/drive/MyDrive/dataset_SUT/valMask.record'
